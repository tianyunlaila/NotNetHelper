...
namespace NotNetHelper
{
    ...
    public static partial class LinqToCAD
    {
        ...
        public static List<T> GetEntsInDatabase<T>(this Database db, string LayerName = null) where T : Entity
        {
            return GetEntsInDatabase<T>(db, LayerName, OpenMode.ForRead, false);
        }
        ...
        /// <returns>返回数据库中类型为T的实体</returns>
        public static List<T> GetEntsInDatabase<T>(this Database db, string LayerName, OpenMode mode, bool openErased) where T : Entity
        {
        ...
        public static List<T> GetSelection<T>(this Database db, string LayerName = null) where T : Entity
        {
            return GetSelection<T>(db, LayerName, OpenMode.ForRead, false);
        }
        ...
        /// <param name="openErased">是否打开已删除的实体</param>
        /// <returns>返回类型为T的实体</returns>
        public static List<T> GetSelection<T>(this Database db, string LayerName, OpenMode mode, bool openErased) where T : Entity
        {
            string dxfname = RXClass.GetClass(typeof(T)).DxfName;
            List<T> ents = new List<T>();
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
        ...
        /// </summary>
        /// <param name="db"></param>
        /// <param name="LayerName">图层名，可以省略</param>
        /// <returns></returns>
        public static List<Entity> GetSelectEntitys(this Database db, string LayerName = null)
        {
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
            Entity entity = null;
            ...
            if (LayerName != null)
            {
                ...
                ents = ed.GetSelection(selops, filter);
            }
            else
            {
